...
from backtester.metrics.configs import PORTFOLIO_PERF_METRICS
...
def extract_metric_value_safely(result_dict: dict, keys: list[str], format_str: str) -> str | None:
    """
...
def format_metric_value_with_color(value: str) -> str:
    """
    ...
    if isinstance(value, str) and "%" in value:
        try:
            ...
            if num_value < 0:
                return str(value, style="bold red")
            elif num_value > 0:
                return str(value, style="bold green")
        except ValueError:
            pass
    return str(value)
